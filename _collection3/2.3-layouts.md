...
| **author**        | `!!map`               | Assign one of the authors in *authors.yml* to a post or page, see [Authors](https://tianqi.name/jekyll-TeXt-theme/collection3/authors) for detail. | 2.2.0 |
