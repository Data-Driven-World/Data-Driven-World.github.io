---
title: Writing Posts
permalink: /collection3/writing-posts
layout: article
nav_key: collection3
sidebar:
  nav: collection3
...
Beside Jekyll’s predefined variables, TeXt define some new variables for each layouts, see [Layouts](https://tianqi.name/jekyll-TeXt-theme/collection3/layouts) for details.
